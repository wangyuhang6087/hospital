...
<body>
<form action="${pageContext.request.contextPath }/hospital/edit" method="post" class="definewidth m20">
<table class="table table-bordered table-hover definewidth m10">
	<tr>
        <td width="10%" class="tableleft">病历号</td>
        <td><input type="text" readonly="readonly" value="${reg.medical_record }"/></td>
    </tr>
    <tr>
	...
	<tr>
        ...
        <td><input value="${reg.hospitalInfor.caregiver }" name="caregiver" type="text"></td>
	</tr>
	<tr>
        <td width="10%" class="tableleft">床位号</td>
        <td><input value="${reg.hospitalInfor.bed_id }" type="text" name="bed_id">
        	<input name="medical_record" type="hidden" value="${reg.medical_record }">
        	
        </td>
	</tr>
	<tr>
        <td width="10%" class="tableleft">缴费押金</td>
        <td><input value="${reg.hospitalInfor.pay_the_deposit }" name="pay_the_deposit" type="text" /></td>
	</tr>
	<tr>
        <td width="10%" class="tableleft">病情</td>
        <td><textarea name="state_illness">${reg.hospitalInfor.state_illness }</textarea></td>
	</tr>
    <tr>
        <td colspan="2">
			<center>
