...
<table class="table table-bordered table-hover definewidth m10">
     <tr>
        ...
        <td><input type="text" name="resource_name" value="${permission.resource_name }"/>
        	<input type="hidden" name="id" value="${permission.id }"/>
        </td>
    </tr>
    <tr>
        <td width="10%" class="tableleft">url</td>
        <td><input type="text" name="resource_url" value="${permission.resource_url }" /></td>
    </tr>
    <tr>
        <td width="10%" class="tableleft">是否有效</td>
        <td>${permission.status ==1?'有效':'无效'  }</td>
    </tr>
